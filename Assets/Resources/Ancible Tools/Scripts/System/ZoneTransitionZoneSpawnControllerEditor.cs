...
{
    [CustomEditor(typeof(ZoneTransitionZoneSpawnController))]
    public class ZoneTransitionZoneSpawnControllerEditor : ZoneSpawnControllerEditor
    {
        public override void OnInspectorGUI()
        {
            serializedObject.Update();
            DrawDefaultInspector();
            if (serializedObject.targetObject is ZoneTransitionZoneSpawnController zoneTransfer)
            {
